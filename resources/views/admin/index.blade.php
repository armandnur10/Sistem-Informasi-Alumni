        ...
        <div class="card shadow border mb-7">
            <div class="card-header">
                ...
                <div class="flex">
                    ...
                    <a href="{{ route('delete-all') }}" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus semua data?')">Delete All Data</a>
                </div>
            </div>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <form action="#" class="action-siswa" method="post">
                                    ...
                                    <a data-href="{{ url('delete/'.$row->id) }}" 
                                        class="btn btn-sm btn-square btn-neutral text-danger-hover m-1 del">
