...
<div class="container">
    <div class="row justify-content-center">
        <div>
            ...
            <section>
                <div class="card" style="background-color: #163785">
                    <div class="row card-body" style="display: flex; justify-content: space-between; align-items: center">
                        ...
                        <div class="col-md-6">
                            <h1 style="color: white;">Lokasi Sekolah</h1>
                            <br>
                            <p style="color: white;">Alamat SMK Harapan Bangsa berada di Jl. Akses UI No.89, RW.1, Tugu, Kec. Cimanggis, Kota Depok, Jawa Barat 16451</p>
                        </div>
                    </div>    
                </div>
            </section>
